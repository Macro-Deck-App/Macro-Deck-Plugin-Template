...
/// <summary>
/// The plugin's one integration. It declares no capabilities yet: add actions to <see cref="Actions"/>,
...
public sealed class PluginIntegration : IPluginIntegration
{
	...
	public PluginIntegration(ILogger logger) => _logger = logger.ForContext<PluginIntegration>();
